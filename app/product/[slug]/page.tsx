...
function getMockProduct(slug: string): Product {
  return {
    ...
    images: [
      ...
      '/images/products/thobe-2.jpg',
      '/images/products/thobe-3.jpg',
      '/images/products/thobe-4.jpg',
    ],
    colors: [
      { name: 'White', value: '#FFFFFF', image: '/images/products/thobe-1.jpg' },
      { name: 'Beige', value: '#F5F5DC', image: '/images/products/thobe-2.jpg' },
      { name: 'Navy', value: '#345995', image: '/images/products/thobe-3.jpg' },
    ],
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
